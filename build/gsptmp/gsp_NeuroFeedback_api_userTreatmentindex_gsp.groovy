...
class gsp_NeuroFeedback_api_userTreatmentindex_gsp extends org.grails.gsp.GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/userTreatment/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(13)
invokeTag('paginate','g',60,['total':(userTreatmentPendingCount ?: 0)],-1)
printHtmlPart(14)
invokeTag('message','g',68,['code':("Historial de tratamientos"),'args':([entityName])],-1)
printHtmlPart(15)
...
printHtmlPart(18)
invokeTag('paginate','g',114,['total':(userTreatmentFinishedCount ?: 0)],-1)
printHtmlPart(19)
