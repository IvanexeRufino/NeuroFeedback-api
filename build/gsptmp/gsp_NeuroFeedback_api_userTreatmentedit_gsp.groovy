...
class gsp_NeuroFeedback_api_userTreatmentedit_gsp extends org.grails.gsp.GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/userTreatment/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',27,['bean':(this.userTreatment),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(this.userTreatment)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(this.userTreatment?.version)],-1)
printHtmlPart(21)
invokeTag('all','f',33,['bean':("userTreatment")],-1)
printHtmlPart(22)
expressionOut.print(message(code: 'default.button.update.label', default: 'Update'))
printHtmlPart(23)
})
invokeTag('form','g',40,['resource':(this.userTreatment),'method':("PUT")],2)
printHtmlPart(24)
})
