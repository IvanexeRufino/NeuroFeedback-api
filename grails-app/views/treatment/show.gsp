...
<html>
    ...
    <body>
        ...
        <div id="show-treatment" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.treatment}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.treatment}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
